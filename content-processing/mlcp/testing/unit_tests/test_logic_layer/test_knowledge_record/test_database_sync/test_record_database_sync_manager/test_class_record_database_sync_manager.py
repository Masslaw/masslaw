...
class TestClassRecordDatabaseSyncManager(unittest.TestCase):
    ...
    def test_sync_record_with_graph_database(self):
        ...
        sync_manager = RecordDatabaseSyncManager(record=record, merging_configuration=merge_configuration)
        sync_manager.sync_with_database(database_manager=mock_graph_db_manager)
