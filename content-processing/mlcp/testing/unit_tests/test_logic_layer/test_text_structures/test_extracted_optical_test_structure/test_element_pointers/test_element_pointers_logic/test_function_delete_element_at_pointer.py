...
from logic_layer.text_structures.extracted_optical_text_structure.element_pointers._element_pointers_logic import delete_element_at_pointer
...
class TestFunctionDeleteElementAtPointer(unittest.TestCase):
    ...
    def test_delete_element_at_pointer(self):
        pointer = (0, 1, 0)
        delete_element_at_pointer(self.document.get_structure_root(), pointer=pointer)
