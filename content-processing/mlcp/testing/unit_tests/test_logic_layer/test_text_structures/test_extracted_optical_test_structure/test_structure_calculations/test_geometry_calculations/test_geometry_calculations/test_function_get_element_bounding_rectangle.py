...
from logic_layer.text_structures.extracted_optical_text_structure._structure_calculations._geometry_calculations._structure_geometry_calculator import get_element_bounding_rectangle
