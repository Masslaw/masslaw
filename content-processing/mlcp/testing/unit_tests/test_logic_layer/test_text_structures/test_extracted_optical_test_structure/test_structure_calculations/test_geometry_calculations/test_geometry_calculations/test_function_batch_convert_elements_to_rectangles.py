...
from logic_layer.text_structures.extracted_optical_text_structure._structure_calculations._geometry_calculations._geometry_calculations import batch_convert_elements_to_rectangles
