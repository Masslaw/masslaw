...
class TestFunctionGetAverageGapBetweenChildElements(unittest.TestCase):

    def test_average_gap_with_child_elements(self):
        element = OpticalTextStructureGroup(
            children=[
                OpticalTextStructureLine(
                    children=[
        ...
        average_gap_width, average_gap_height = get_average_gap_between_child_elements(element)

        expected_average_gap_width = 0
        expected_average_gap_height = 15
