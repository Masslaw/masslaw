...
from resources_layer.aws_clients.dynamodb_client import DynamoDBTableManager


@moto.mock_dynamodb
class TestClassDynamoDBTableManager(unittest.TestCase):
    ...
    def test_put_and_get_item(self):
        client = DynamoDBTableManager(self.table_name, (self.aws_access_key_id, self.aws_secret_access_key, self.session_token))
