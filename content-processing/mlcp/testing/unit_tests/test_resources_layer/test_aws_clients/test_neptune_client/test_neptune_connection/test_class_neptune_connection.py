...
class TestClassNeptuneConnection(unittest.TestCase):
    ...
    @patch("resources_layer.aws_clients.neptune_client._neptune_connection.sleep", side_effect=None)
    @patch("resources_layer.aws_clients.neptune_client._neptune_connection.DriverRemoteConnection", autospec=True)
