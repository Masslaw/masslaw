...
from logic_layer.text_structures.extracted_optical_text_structure._structure_calculations._geometry_calculations._geometry_calculations import get_average_gap_between_child_elements
from logic_layer.text_structures.extracted_optical_text_structure._structure_calculations._geometry_calculations._geometry_calculations import get_average_gap_between_nested_child_elements
from logic_layer.text_structures.extracted_optical_text_structure._structure_calculations._geometry_calculations._geometry_calculations import get_element_children_average_size
from logic_layer.text_structures.extracted_optical_text_structure._structure_calculations._geometry_calculations._geometry_calculations import get_element_nested_children_average_size
from logic_layer.text_structures.extracted_optical_text_structure._structure_calculations._geometry_calculations._geometry_calculations import get_element_bounding_rectangle
