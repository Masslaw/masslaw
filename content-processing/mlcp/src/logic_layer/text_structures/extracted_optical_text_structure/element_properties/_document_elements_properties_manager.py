...
from logic_layer.text_structures.extracted_optical_text_structure.element_pointers._document_element_pointers_handler import DocumentElementPointersHandler
