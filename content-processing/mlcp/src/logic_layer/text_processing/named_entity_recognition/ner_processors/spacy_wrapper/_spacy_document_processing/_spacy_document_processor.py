...
from logic_layer.text_processing.named_entity_recognition.ner_processors.spacy_wrapper._spacy_document_processing._knowledge_record_building import SpacyDocumentKnowledgeRecordBuilder
