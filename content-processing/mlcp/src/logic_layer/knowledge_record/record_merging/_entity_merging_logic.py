...
def merge_entities(merge_to: KnowledgeRecordEntity, to_merge: KnowledgeRecordEntity):
    merge_to.set_id(to_merge.get_id() or merge_to.get_id())
    merge_to.set_label(to_merge.get_label() or merge_to.get_label())
    merge_to.set_properties(merge_entity_properties(merge_to.get_properties(), to_merge.get_properties()))
