...
from src.lambda_src.modules.masslaw_cases_objects.masslaw_case_file import *
...
from src.lambda_src.modules.masslaw_cases_config._security_config import *
from ...opensearch_client._index_manager import *
from ...step_functions_manager._state_machine_manager import *
from src.lambda_src.modules.masslaw_cloud_configurations._masslaw_cloud_configurations import *
from src.lambda_src.modules.masslaw_cloud_configurations._config import *


class MasslawFileTypeNotSupportedException(Exception): pass
...
class MasslawCaseStorageManager:
    ...
    def get_case_file_download_url(self, user_id, file_id, content_path):
        ...
        url = bucket_manager.get_object_presigned_url(file_key, FILE_DOWNLOAD_URL_EXPIRATION_SECONDS)
    ...
    def start_uploading_file(self, user_id, file_name, num_parts, file_languages):
        ...
        file_instance.update_data({
            'name': file_name,
            'type': file_type,
            'languages': file_languages,
            'upload_id': mp_upload_data['upload_id'],
    ...
    def delete_file(self, file_id):
        ...
        open_search_index_name = f'{self.__case_instance.get_case_id()}{MASSLAW_CASE_FILES_SEARCH_INDEX_SUFFIX}'
    ...
    def start_case_file_processing_pipeline(self, file_instance: MasslawCaseFileInstance, stage='prod'):
        ...
        pipeline_state_machine_manger.start_execution({
            "file_id": file_instance.get_file_id(),
            "stage": stage
        })

    def assert_file_type_supported(self, file_type):
        supported_file_types = list(get_configuration_value(key=SUPPORTED_MLCP_FILE_TYPES))
