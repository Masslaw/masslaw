from text_processing_success.modules.remote_data_management import DataHolder
from text_processing_success.modules.aws_clients.dynamodb_client import DynamoDBTableManager
from text_processing_success.modules.dictionary_utils import dictionary_utils
