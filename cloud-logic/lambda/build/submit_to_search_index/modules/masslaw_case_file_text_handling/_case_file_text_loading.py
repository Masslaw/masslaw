from submit_to_search_index.modules.aws_clients.s3_client import S3BucketManager
from submit_to_search_index.modules.masslaw_cases_config import storage_config
