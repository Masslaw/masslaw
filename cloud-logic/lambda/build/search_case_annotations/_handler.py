from search_case_annotations.modules.aws_clients.open_search_client import OpenSearchIndexManager
from search_case_annotations.modules.lambda_base import lambda_constants
from search_case_annotations.modules.lambda_handler_template_http_invoked_masslaw_case_management_api import MasslawCaseManagementApiInvokedLambdaFunction
from search_case_annotations.modules.masslaw_case_users_management import MasslawCaseUserAccessManager
from search_case_annotations.modules.masslaw_cases_config import opensearch_config
from search_case_annotations.modules.masslaw_cases_objects import MasslawCaseInstance


class SearchCaseAnnotations(MasslawCaseManagementApiInvokedLambdaFunction):
    def __init__(self):
        MasslawCaseManagementApiInvokedLambdaFunction.__init__(self, default_response_body={'results': []}, request_query_string_parameters_structure={'case_id': [str], 'search_query': [str], 'files': [str, None], })
        self.__case_id = ''
        self.__search_query = ''
        self.__files = None
    ...
    def _execute(self):
        ...
        result = case_index_manager.query(field='text', query=self.__search_query, sort={"_score": "desc"}, include_source_fields=['file_id', 'name'], highlight_padding=100, documents=search_files)
