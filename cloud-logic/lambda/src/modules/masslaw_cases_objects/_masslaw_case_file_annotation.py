...
from src.modules.masslaw_cases_config import annotations_config
...
from src.modules.masslaw_cases_objects._exceptions import MasslawCaseFileAnnotationDataUpdateException
