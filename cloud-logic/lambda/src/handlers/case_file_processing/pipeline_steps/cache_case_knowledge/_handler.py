...
_s3_bucket_manager = S3BucketManager(CASES_KNOWLEDGE_BUCKET_ID)
...
class CacheCaseKnowledge(MasslawStepFunctionCaseFilePipelineNodeHandler):
    ...
    def _execute(self):
        ...
        self.__knowledge = {'entities': [], 'connections': []}
        self.__get_entities()
    ...
    def __save_to_s3(self):
        s3_file_key = f'{self.__case_id}/knowledge.json'
        json_data = json.dumps(self.__knowledge)
