from service.extracted_optical_text_structure.structure_calculations._text_calculations._bidirectional_calculations import calculate_element_text_direction
