...
const FileDisplayFileData = styled.div`
    ...
    ${({orientation}) =>
            (orientation === 'horizontal') ?
            'width: calc(35% - 1px); height: 100%; max-width: calc(35% - 1px); max-height: 100%; border-left: 1px solid #505050;' :
            'width: 100%; height: calc(50% - 1px); max-width: 100%; max-height: calc(50% - 1px); border-top: 1px solid #505050;'
    }
`
